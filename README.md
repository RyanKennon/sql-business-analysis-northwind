...
- Query: `queries/revenue_by_category.sql`
- Finding: Beverages is the top revenue-generating category at roughly $92.2M, followed by Confections ($66.3M) and Meat/Poultry ($64.9M). Revenue is fairly evenly distributed across the remaining categories rather than concentrated in one or two, suggesting the business isn't overly dependent on a single product line.
